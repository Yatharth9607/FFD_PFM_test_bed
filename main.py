            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            children=[
                                html.Label(
                                    children="Distance from bottom (m)",
                                    style={
                                        "display": "inline-block",
                                        "padding-left": "10px",
                                        "padding-right": "10px",
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Label(
                            "Left", style={"font-weight": "bold", "textAlign": "center"}
                        ),
                        html.Div(
                            children=[
                                html.Label(
                                    children="y-Velocity (m/s)",
                                    style={
                                        "display": "inline-block",
                                        "padding-left": "10px",
                                        "padding-right": "10px",
                        ...
                        html.Div(
                            children=[
                                html.Label(
                                    children="Heat Transfer Coefficient (W/m\u00B2K)",
                                    style={
                                        "display": "inline-block",
                                        "padding-left": "10px",
                                        "padding-right": "10px",
                        ...
                        html.Label(
                            "Top", style={"font-weight": "bold", "textAlign": "center"}
                        ),
                        html.Div(
                            children=[
                                html.Label(
                                    children="x-Velocity (m/s)",
                                    style={
                                        "display": "inline-block",
                                        "padding-left": "10px",
                                        "padding-right": "10px",
                        ...
                        html.Div(
                            children=[
                                ...
                                html.Div(
                                    children=[
                                        html.Label(
                                            children="Velocity Potential Iterations",
                                            style={
                                                "display": "inline-block",
                                                "padding-left": "10px",
                                                "padding-right": "10px",
                                ...
                                html.Div(
                                    children=[
                                        html.Label(
                                            children="Temperature Iterations",
                                            style={
                                                "display": "inline-block",
                                                "padding-left": "10px",
                                                "padding-right": "10px",
...
@app.callback(
    [
        ...
        Output("mpl-id", "src"),
        Output("time_complex-id", "children"),
    ],
    [Input("button", "n_clicks")],
    [
        State("v1-id", "value"),
        State("T1-id", "value"),
        State("theta1-id", "value"),
        State("v2-id", "value"),
        State("T2-id", "value"),
        State("theta2-id", "value"),
        State("q-id", "value"),
        State("b-id", "value"),
        State("l-id", "value"),
        State("v_l-id", "value"),
        ...
        State("T_b-id", "value"),
        State("h_b-id", "value"),
        State("solver-id", "value"),
        State("N-id", "value"),
        State("omega-id", "value"),
        State("temp-id", "value"),
        State("tmax-id", "value"),
        State("t_mul-id", "value"),
        State("vel_iter-id", "value"),
        State("T_iter-id", "value"),
        State("P_iter-id", "value"),
        State("mon_x-id", "value"),
        State("mon_y-id", "value"),
        State("T_ref-id", "value"),
        State("PFM_iter-id", "value"),
        State("VP_iter-id", "value"),
        State("T_iter-id2", "value"),
...
def cfd_results(
    ...
    if Q_graph_layout == 1:
        ...
        Res_plot = {
            "data": [
                go.Scatter(x=monitor_data[0], y=monitor_data[1], mode="lines"),
